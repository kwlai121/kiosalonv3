...
if ( !class_exists( 'ReduxFramework_extension_wbc_importer' ) ) {
    ...
    class ReduxFramework_extension_wbc_importer {
        ...
        public function demoFiles() {
            ...
            $dir_array = is_object($this->filesystem) ? $this->filesystem->dirlist( $this->demo_data_dir, false, true ) : array();
        ...
        function add_importer_section() {
            ...
            $this->parent->sections[] = array(
                ...
                'desc'   => '<p class="description">'. apply_filters( 'wbc_importer_description', esc_html__( 'Works best to import on a new install of WordPress', LION_CURRENT_THEME ) ).'</p>',
